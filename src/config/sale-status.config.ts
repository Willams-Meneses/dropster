...
export const SALE_STATUS_CONFIG: Record<SaleStatus, StatusChipConfig> = {
  paid: { label: 'Listo para despachar', backgroundColor: '#FDE68A', textColor: '#92400E' },
  shipped: { label: 'En proceso', backgroundColor: '#E0F2FE', textColor: '#0369A1' },
...
export const SALE_STATUS_MESSAGES: Record<SaleStatus, string> = {
  paid: 'Tenés que darle el paquete a tu conductor mañana.',
  shipped: 'El pedido está en camino al cliente.',
